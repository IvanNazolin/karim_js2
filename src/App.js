...
const HINT_PHRASE = ""
//14 words
const birthdayText = "known. ever have I which girl best the and awesome most the are you Sonya,"
...
function Heart(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null} scale={0.1}>
      ...
      <LoveText rotation={[-Math.PI/2, group.current ? group.current.rotation.z : 0, -Math.PI]} position={[0, 0, 25]} fontSize={7}>Sonya</LoveText>
    </group>
  )
}
